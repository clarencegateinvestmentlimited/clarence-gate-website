                    ...
                    <div className="lg:w-2/3 w-full">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 text-sm text-gray-400 mb-6 dm-sans">
                                ...
                                <span className="text-[#76B82D] font-semibold uppercase tracking-wider">Analysis | Economy |  Industry</span>
                            </div>

                            {/* Title */}
                            <h1 className="text-2xl md:text-4xl font-light leading-tight text-gray-900 mb-10 dm-sans">
                                Nigeria’s Construction Industry in 2024
                                <br />
                                ...
                                <section>
                                    ...
                                    <div>
                                        <ul className="list-disc ml-6 space-y-3 text-gray-600">
                                            <li>
                                                <strong>Funding gaps:</strong>  Many firms struggle to finance large projects.
                                            </li>
                                            <li>
                                                <strong> Project inefficiencies: </strong>Poor management leads to delays and cost overruns.
                                            </li>
                                            <li>
                                                <strong> Intense competition:</strong> The market is crowded with both new and established players.
                                            </li>
                                        </ul>
