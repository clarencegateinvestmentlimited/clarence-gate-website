...
const SoFresh: React.FC = () => {
    const [isPlaying, setIsPlaying] = useState(false);
    const videoId = "s-YO8QFNSzY"; // Extracted from your URL
            ...
            <div className="max-w-5xl mx-auto px-6 py-12 font-sans text-gray-800 overflow-hidden">
                ...
                >
                    <h1 className="text-2xl md:text-4xl font-bold text-gray-200 leading-tight">
                        Expanding So Fresh's Product Offerings and Amplifying Access to <span className="text-[#94257a]">Healthy Food in Nigeria </span>
                    </h1>
                    <p className="mt-6 text-lg text-gray-200 italic border-l-4 border-[#94257a] pl-4">
                        Innovative healthy options fuel growth: So Fresh expands menu, boosts revenue, and reaches new customers.
                    </p>
                </motion.header>
                ...
                <div className="space-y-20">
                    ...
                    <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="pt-10 border-t border-gray-100">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {/* Result 1: Operational Efficiency */}
                            <motion.div
                                variants={fadeInUp}
                                whileHover={{ y: -5 }}
                                className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 border-t-4 border-t-[#94257a]"
                            >
                                <p className="text-gray-700 text-lg">
                                    Improved operational efficiency through streamlined processes and
                                    enhanced collaboration across subsidiaries.
                                </p>
                            </motion.div>

                            {/* Result 2: Innovation & Market Share */}
                            <motion.div
                                variants={fadeInUp}
                                whileHover={{ y: -5 }}
                                className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 border-t-4 border-t-[#94257a]"
                            >
                                <p className="text-gray-700 text-lg">
                                    Enhanced innovation and development of new solutions, leading to
                        ...
                        <motion.p
                            variants={fadeInUp}
                            className="mt-8 text-xl font-medium text-gray-200 text-center bg-white/5 py-10 rounded-2xl px-6"
                        >
                            By engaging Caladium and focusing on strategy execution, Sohcahtoa Holdings
                            successfully improved operational efficiency and has maintained its
